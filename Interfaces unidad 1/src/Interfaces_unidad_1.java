...
//ingresar un texto amplio en un JtextArea con scroll. Poner un botón debajo y saber si se ha introducido un texto
...
//meter los valores numericos de los colores y ponerlo de fondo del botón
...
//El menu general es el JMenuBar. La primera pestaña seria JMenu. Los desplegables dentro de la primera pestaña
//serian m1,m2 y m3
        mb= new JMenuBar();
        setJMenuBar(mb);
...
//selecciona otro.
        ...
        add(radio1);
        bg.add(radio1);
        rd2= new JRadioButton("opcion 2");
        rd2.setBounds(300,830,100,20);
        rd2.addChangeListener(this);
        add(rd2);
        bg.add(rd2);
        rd3= new JRadioButton("opcion 3");
	...
	/* ¿Cuando llamar al actionevent o al changeevent. Action event esta pendiente de que se produzca una accion, ejemplo un click, 
	 * reaccion tras el evento. changeevent esta pendiente de que cambie un estado, por eso se usa con radiobutton
	 */
	
	public void actionPerformed(ActionEvent e) {
//Creamos una variable de tipo container para poder trabajar con todo el contenedor. En función de lo que ha pulsado
...
//al presionar el boton 4 sumo los numeros y lo pongo en el titulo (p.58 u1)
	...
	public static void main(String[] args) {
		...
		**/
        ...
        f.setVisible(true);
        //tamaño de la ventana no modificable en tiempo de ejecución
